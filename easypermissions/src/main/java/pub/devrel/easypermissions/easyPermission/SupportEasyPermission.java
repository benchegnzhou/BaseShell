 ...
 */
public class SupportEasyPermission {
    ...
    private SupportEasyPermission(Object object) {
        this.object = object;
    }

    public static SupportEasyPermission with(Activity activity) {
        return new SupportEasyPermission(activity);
    }

    public static SupportEasyPermission with(Fragment fragment) {
        return new SupportEasyPermission(fragment);
    }

    public SupportEasyPermission permissions(String... permissions) {
        this.mPermissions = permissions;
        return this;
    }

    public SupportEasyPermission rationale(String rationale) {
        this.mRationale = rationale;
        return this;
    }

    public SupportEasyPermission addRequestCode(int requestCode) {
        this.mRequestCode = requestCode;
        return this;
    }

    public SupportEasyPermission positveButtonText(@StringRes int positiveButtonText) {
        this.mPositiveButtonText = positiveButtonText;
        return this;
    }

    public SupportEasyPermission nagativeButtonText(@StringRes int negativeButtonText) {
     ...
     * 使用{@link SupportEasyPermission#hasPermissions(Context, String...)}进行判断
     *
